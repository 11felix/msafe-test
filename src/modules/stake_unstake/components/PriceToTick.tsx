      ...
      <div className="flex gap-[1.927vw]">
        <div className="flex flex-col">
          <div className="flex flex-col">
            ...
            <input
              type="number"
              className="w-[13.697vw] h-[2.08vw] border rounded-[0.364vw] no-spinner px-[0.45vw] font-poppinsbold text-[1.145vw] focus:outline-none focus:ring-0 leading-[1.145vw] "
            />
          </div>
        ...
        <div className="flex flex-col">
          <div className="flex flex-col">
            ...
            <input
              type="number"
              className="w-[13.697vw] h-[2.08vw] border rounded-[0.364vw] no-spinner px-[0.45vw] font-poppinsbold text-[1.145vw] focus:outline-none focus:ring-0 "
            />
